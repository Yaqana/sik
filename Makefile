...
siktacka-server: siktacka-server.o err.o siktacka.o data_structures.o server.o events.o
	$(CC) $(LFLAGS) $^ -o $@

siktacka-client: siktacka-client.o err.o siktacka.o data_structures.o events.o
	$(CC) $(LFLAGS) $^ -o $@
